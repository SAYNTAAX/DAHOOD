if game.Players.LocalPlayer:IsInGroup(12271076) then
    ...
    game.RunService.Stepped:Connect(function()
        game.ReplicatedStorage.MainEvent:FireServer("JoinCrew", 12271076)
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "Error!",
        Text = "¡Únase al grupo Roblox para que funcione! Enlace copiado a su portapapeles!.",
        Duration = 7,
    })
